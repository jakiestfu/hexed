...
import { Card, CardContent, CardHeader, CardTitle, Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@binspector/ui';
  ...
  return (
    <div className="grid gap-4 md:grid-cols-3">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-yellow-500">{modified.length}</div>
