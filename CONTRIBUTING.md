# Contributing to Binspector

Thank you for your interest in contributing to Binspector!
...
2. Update types in `@binspector/types` if needed
3. Implement core logic in appropriate package
4. Add UI components in `@binspector/ui` or `apps/web`
