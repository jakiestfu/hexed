...
export interface HexCanvasProps {
  rows?: FormattedRow[] // Optional, for backward compatibility
  layout: LayoutMetrics | null
  visibleDataLayout: VisibleDataLayoutMetrics
  data?: Uint8Array // Optional, manager will provide data
  showAscii?: boolean
  className?: string
  ...
  fileScrollManager?: FileScrollManager | null // Manager instance to read data from
}
...
export const HexCanvas = forwardRef<HexCanvasRef, HexCanvasProps>(
  (
    ...
    const { handleKeyDown } = useKeyboardNavigation({
      ...
      dataLength: totalSize ?? data?.length ?? 0,
